export declare type TransferStatus = ('READY' | 'PENDING_APPROVAL' | 'SENT' | 'RECEIVED' | 'DECLINED' | 'ERROR' | 'PAUSED' | 'CANCELLED' | 'SENT_TIMEOUT' | 'SENT_ERROR');
/**
 ...
 */
export declare type TransferCreateParams = {
    /**
 ...
 */
export declare type TransferQueryParams = {
    /**
