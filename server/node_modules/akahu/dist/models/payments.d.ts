export declare type PaymentStatus = ('READY' | 'PENDING_APPROVAL' | 'PAUSED' | 'SENT' | 'DECLINED' | 'ERROR' | 'CANCELLED');
/**
 ...
 */
export declare type PaymentCreateParams = {
    /**
 ...
 */
export declare type PaymentQueryParams = {
    /**
