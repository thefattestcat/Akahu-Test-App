...
export declare class TransfersResource extends BaseResource {
     ...
     */
    get(token: string, transferId: string): Promise<Transfer>;
    /**
     ...
     */
    list(token: string, query?: TransferQueryParams): Promise<Transfer[]>;
    /**
     * Initiate a transfer between two of the users bank accounts.
     *
     * {@link https://developers.akahu.nz/reference/post_transfers}
     */
    create(token: string, transfer: TransferCreateParams): Promise<Transfer>;
}
